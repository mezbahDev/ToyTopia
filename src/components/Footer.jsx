    ...
    >
      <div className="flex flex-col gap-5 w-1/3">
        ...
        <div className="flex items-center gap-2">
          ...
          <p className="text-[18px]">+8801521559029</p>
        </div>
        <div className="flex items-center gap-2">
          <IoMdMail className="text-[20px]" />
          <p className="text-[18px]">mezbahuddin9029@gmail.com</p>
        </div>
      </div>
      ...
      <div className="w-full flex flex-col items-center gap-4">
        ...
        <button className="w-7/12 bg-[#FBC270] py-3 cursor-pointer rounded-full text-white font-semibold text-[20px] hover:bg-[#4178a1] transition-colors">
          Subscribe
        </button>
